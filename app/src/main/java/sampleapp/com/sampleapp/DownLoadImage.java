...
public class DownLoadImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bucket__create);
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    File imgFile = new  File(android.os.Environment.getExternalStorageDirectory().getAbsolutePath()+"/download_fromCloud_Monday"," IMG-20141218-WA0001.jpg " );
                    if(imgFile.exists()) {
                        Bitmap mymap = BitmapFactory.decodeFile(android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/download_fromCloud_Monday/IMG-20141218-WA0001.jpg ");
