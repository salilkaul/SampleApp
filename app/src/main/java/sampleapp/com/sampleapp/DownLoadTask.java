...
public class DownLoadTask extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... params) {
        try {
            CloudStorage.downloadFile("saliltestbucket"," IMG-20141218-WA0001.jpg ",android.os.Environment.getExternalStorageDirectory().getAbsolutePath()+"/download_fromCloud_Monday");
        }catch(Exception ex){
            ex.printStackTrace();
